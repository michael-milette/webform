...
if ($debug) {
    ...
    $recipient = 'CFC.ServicesWeb-WebServices.SWC@cfc-swc.gc.ca';
}
    ...
    if (preg_match('/^[A-Za-z][A-Za-z0-9_:\.-]*/', $key)) {
        ...
        if (!in_array($key, array('submit', 'zip', 'cBee', 'cemail')) && trim($value) != '') {
            ...
            switch ($key) {
                ...
                case 'objet':   // UI Language. Don't include in body of message.
                case 'subject':   // UI Language. Don't include in body of message.
